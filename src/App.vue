<script setup>
  import { ToolbarComponent, ItemDirective as Item,
    ItemsDirective as Items
  } from '@syncfusion/ej2-vue-navigations';
</script>
<template>
  <div style = "margin: 15% 20%">
    <ToolbarComponent width="875px" overflow-mode="Extended">
      <Items>
        <Item prefix-icon="tb-icons e-cut-icon" text="Cut"></Item>
        <Item prefix-icon="tb-icons e-copy-icon" text="Copy"></Item>
        <Item prefix-icon="tb-icons e-paste-icon" text="Paste"></Item>
        <Item type="Separator"></Item>
        <Item suffix-icon="tb-icons e-bold-icon" text="Bold"></Item>
        <Item suffix-icon="tb-icons e-italic-icon" text="Italic"></Item>
        <Item suffix-icon="tb-icons e-underline-icon" text="Underline"></Item>
        <Item type="Separator"></Item>
        <Item suffixIcon="e-bullets-icon tb-icons" text="Bullets"></Item>
        <Item suffixIcon="e-numbering-icon tb-icons" text="Numbering"></Item>
        <Item type="Separator"></Item>
        <Item suffixIcon="e-undo-icon tb-icons" text="Undo"></Item>
        <Item suffixIcon="e-redo-icon tb-icons" text="Redo"></Item>
        <Item type="Separator"></Item>
        <Item suffixIcon="e-alignleft-icon tb-icons" text="Left"></Item>
        <Item suffixIcon="e-alignright-icon tb-icons" text="Right"></Item>
        <Item suffixIcon="e-aligncenter-icon tb-icons" text="Center"></Item>
        <Item suffixIcon="e-alignjustify-icon tb-icons" text="Justify"></Item>
        <Item type="Separator"></Item>
        <Item suffixIcon="e-table-icon tb-icons" text="Table"></Item>
        <Item suffixIcon="e-picture-icon tb-icons" text="Picture"></Item>
        <Item type="Separator"></Item>
        <Item :template="'fontSize'"></Item>
          <template v-slot:fontSize>
            <Input type = "number" placeHolder = "Enter a font size"/>       
          </template>
          <Item :template="'fontFamily'"></Item>
          <template v-slot:fontFamily>
            <select>
              <option>Arial</option>
